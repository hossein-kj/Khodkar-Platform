 ...
 var pred = predicate
    .create('MasterDataKeyValue.IsType', '==', true)
      .and('Language','==','en');
     ...
     .expand('MasterDataKeyValue')
      .select('MasterDataKeyValue.Id,MasterDataKeyValue.ParentTypeId,MasterDataKeyValue.Code,MasterDataKeyValue.Order,MasterDataKeyValue.Name,MasterDataKeyValue.Key,MasterDataKeyValue.Value,MasterDataKeyValue.IsLeaf,MasterDataKeyValue.TypeId,Name')
