 $('#i920851729844434da47bb02221e8e808').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('ایجاد و ویرایش کاربران');var asPageEvent = '#i920851729844434da47bb02221e8e808'; var asPageId = '.i920851729844434da47bb02221e8e808.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({security_Role_getAllByDefaultsLanguage:"/odata/security/Roles?$select=Id%2CParentId%2CName%2COrder%2CIsLeaf%2CDescription",security_Group_getAllByDefaultsLanguage:"/odata/security/Groups?$select=Id%2CParentId%2CName%2COrder%2CIsLeaf%2CDescription",security_User_GetUsersByPaging:"/security/user/GetUsersByPagination/@groupId/@orderby/@skip/@take",security_User_Save:"/security/user/Save",security_User_Dell:"/security/user/delete"}, $.asUrls); var
