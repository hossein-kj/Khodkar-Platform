...
$drpType.asDropdown({
    source: {
        ...
        url: $.asInitService($.asUrls.cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId, [{ name: '@typeId', value: 1043 }])
...
$drpCodes.asDropdown({
    source: {
        ...
        url: $.asInitService($.asUrls.cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId, [{ name: '@typeId', value: 1041 }])
        , displayDataField: 'Name'
          , valueDataField: 'Id',
        orderby: 'Order'
    }
...
$drpDllStorPlace.asDropdown({
    source: {
        hierarchy:
        {
            ...
            url: $.asInitService($.asUrls.cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId, [{ name: '@typeId', value: 1044 }])
        , displayDataField: 'Name'
          , valueDataField: 'Id',
        orderby: 'Order'
    }
...
as("#btnCancelRestor").click(function () {
      ...
      if(dotNetType === 756 || dotNetType === 757 || dotNetType === 758 || dotNetType === 979){
           $frm.asAjax({
            ...
            success: function (result) {
              ...
              $.asShowMessage({ template: "error", message: "  امکان کامپایل فقط برای نوع اسمبلی وجود دارد" });
          }
     ...
     $btnKhodkarBreakpoint.click(function () {
         ...
         if(selectedEditorId === 197){
            ...
            + "#End If" + "\n" 
                 ...
                 $.asShowMessage({ template: "error", message: "  ابتدا یک کد را انتخاب نمایید" })
        }
       ...
       $btnWcfManager.click(function () {
            ...
            $winWcfManager.asModal('load', $.asInitService($.asFormUrl,[{name:"@url",value:$.asUrlAsParameter("fa/admin/develop/codes/os/dotnet/wcf-manager")},{name:"@isModal",value:true}]));
    });
    
    
    $btnEfMigrationGenerator.click(function () {
            if(selectedCodeId !== 0){
            $winEfMigrationGenerator.asModal('load', $.asInitService($.asFormUrl,[{name:"@url",value:$.asUrlAsParameter("fa/admin/develop/codes/os/dotnet/ef-migration-generator")},{name:"@isModal",value:true}])
            ,{codeId:selectedCodeId});
            }else{
                 $.asShowMessage({ template: "error", message: "  ابتدا یک کد را انتخاب نمایید" })
        }
  ...
  $btnOutputManager.click(function () {
            ...
            $winOutputManager.asModal('load', $.asInitService($.asFormUrl,[{name:"@url",value:$.asUrlAsParameter("fa/admin/develop/codes/os/dotnet/output-manager")},{name:"@isModal",value:true}])
      ...
      $btnDebugManager.click(function () {
            ...
            $winDebugManager.asModal('load', $.asInitService($.asFormUrl,[{name:"@url",value:$.asUrlAsParameter("fa/admin/develop/codes/os/dotnet/debug-manager/")},{name:"@isModal",value:true}])
            ,{codeId:selectedCodeId});
            }else{
                 $.asShowMessage({ template: "error", message: "  ابتدا یک کد را انتخاب نمایید" })
        }
         ...
         $frm.asAjax({
            ...
            success: function (result) {
              ...
              $drpCodes.asDropdown("removeItem");
                 ...
                 $.asShowMessage({ template: "error", message: " برای حذف یک کد را انتخاب نمایید" })
        }
    });
