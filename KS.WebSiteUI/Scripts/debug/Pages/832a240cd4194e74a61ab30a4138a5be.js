 $('#i832a240cd4194e74a61ab30a4138a5be').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('File Selector');var asPageEvent = '#i832a240cd4194e74a61ab30a4138a5be'; var asPageId = '.i832a240cd4194e74a61ab30a4138a5be.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({fms_GetFileAndFoldersOfPathByPaging:"/fms/GetByPagination/@path/@orderby/@skip/@take/@createThumbnail"}, $.asUrls); 
var 
     $win=$(asPageId),
