...
$divRoles.asAfterTasks([
    ...
    requestHandler:function(request){
        ...
        request.url = $.asInitService($.asUrls.cms_file_getByDefaultsLanguagesAndTypeCodeByPaging, [
            ...
            success: function (result) {
             ...
             onSuccess()
                ...
                $btnDell.button('reset')
                       ...
                       $.asShowMessage({template:"error", message: "فایلی برای حذف انتخاب نشده است ."});
            }
