...
$drpMigrations.asDropdown("init","  ابتدا کلاس Configuration و نگارش اسمبلی را انتخاب نمایید",{
    source: {
...
$drpTargetMigration.asDropdown("init","  ابتدا کلاس Configuration و نگارش اسمبلی را انتخاب نمایید",{
    source: {
         displayDataField: 'Name'
          , valueDataField: 'Name',
        orderby: 'Name'
...
$drpSourceMigration.asDropdown("init","  ابتدا کلاس Configuration و نگارش اسمبلی را انتخاب نمایید",{
    source: {
         displayDataField: 'Name'
          , valueDataField: 'Name',
        orderby: 'Name'
...
$drpAction.asDropdown({
    source: {
        localData:[{Value:"اجرای یک Migration",Key:1},{Value:"  ایجاد Migration جدید",Key:2},{Value:"تولید اسکریپت یک بین دو Migration  ",Key:3}]
        , displayDataField: 'Value'
          , valueDataField: 'Key',
        orderby: 'Value'
    }
              ...
              if(selectedVersion > 0 && $drpClass.asDropdown('selected') && selectedAction !== 2){
                    as("#divMigrations").asAfterTasks([
                       ...
                       [
                        ...
                        classes.push({Name:"دیتابیس خالی"});
                ...
                if(selectedAction===2){
                     ...
                     $win.asAjax({
                        ...
                        data: JSON.stringify({
                            ...
                            SourceName:$drpSourceMigration.asDropdown('selected').value === "دیتابیس خالی"  ? "": $drpSourceMigration.asDropdown('selected').value,
                            Language:selectedLanguage,
                            ConnectionId:selectedConnectionId,
                            ConfigurationCodeId: $drpClass.asDropdown('selected').value,
                            DllVersion : selectedVersion,
