...
var 
    ...
    menuUrl= $.asInitService($.asUrls.cms_link_public_getAll,[{name:'@lang',value:'fa'},{name:'@isMobile',value:false}]),
...
if ($.asIsAuthenticated()) {
    menuUrl = $.asInitService($.asUrls.cms_link_userMenus,[{name:'@lang',value:'fa'},{name:'@isMobile',value:false}]),

    as("#defaultTemplate_login_link").html(' <a class="top-link-divider" href="/logoff/"  >خروج</a>')
           var loadLinks = function (){
      return $.asAjaxTask({
     url:$.asInitService($.asUrls.cms_link_userAccess,[{name:'@lang',value:'fa'},{name:'@isMobile',value:false}])
      });
}
