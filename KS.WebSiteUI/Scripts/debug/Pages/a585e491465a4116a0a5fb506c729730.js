 $('#ia585e491465a4116a0a5fb506c729730').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('ایجاد و ویرایش زبان و فرهنگ');var asPageEvent = '#ia585e491465a4116a0a5fb506c729730'; var asPageId = '.ia585e491465a4116a0a5fb506c729730.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({cms_languageAndCulture_save:"/cms/languageAndCulture/save",cms_languageAndCulture_public_getAll:"/cms/languageAndCulture/public/getAll",security_Role_getAllByDefaultsLanguage:"/odata/security/Roles?$select=Id%2CParentId%2CName%2COrder%2CIsLeaf%2CDescription",cms_languageAndCulture_byJsFile_get:"/cms/languageAndCulture/Get/@id",cms_languageAndCulture_delete:"/cms/languageAndCulture/delete"}, $.asUrls); var 
 $frm = as("#frmLang"),
...
as("#btnCancelRestor").click(function () {
    ...
    $btnDell.click(function () {
        if(languageAndCultureId === 0){
            $.asShowMessage({ template: "error", message: "برای حذف یک زبان و فرهنگ را انتخاب نمایید"})
            return;
        }
         $frm.asAjax({
    ...
    $btnSave.click(function () {
        if(flagId===0){
                 $.asShowMessage({template: "error", message:  "تصویر پرچم انتخاب نشده است." });
                 return;
        }
