 $('#i32a199dfcbeb48e7b57d99638d2ffa41').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('.Net Experts');var asPageEvent = '#i32a199dfcbeb48e7b57d99638d2ffa41'; var asPageId = '.i32a199dfcbeb48e7b57d99638d2ffa41.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({}, $.asUrls); 
            as('#myCarousel_01').carousel({
                interval: 4000
            });

            as('#myCarousel_02').carousel({
                interval: 4000
            });
