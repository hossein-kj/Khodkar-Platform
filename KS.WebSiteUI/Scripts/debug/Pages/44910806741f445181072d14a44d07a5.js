 $('#i44910806741f445181072d14a44d07a5').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('کارشناسان.نت');var asPageEvent = '#i44910806741f445181072d14a44d07a5'; var asPageId = '.i44910806741f445181072d14a44d07a5.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({}, $.asUrls); 
