...
$drpContexts.asDropdown({
        source: {
            ...
            orderby: 'MasterDataKeyValue.Order',
              url: $.asInitService($.asUrls.cms_masterDataKeyValue_GetByOtherLanguagesAndTypeId, [{ name: '@typeId', value: 1039 },{ name: '@lang', value: $.asLang }])
        }
         , parentMode: "uniq"
    });
