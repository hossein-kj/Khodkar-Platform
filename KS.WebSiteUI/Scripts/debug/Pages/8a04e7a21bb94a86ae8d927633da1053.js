 $('#i8a04e7a21bb94a86ae8d927633da1053').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('انتخاب دایرکتوری');var asPageEvent = '#i8a04e7a21bb94a86ae8d927633da1053'; var asPageId = '.i8a04e7a21bb94a86ae8d927633da1053.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({fms_GetFoldersOfPathByPaging:"/fms/GetFoldersByPagination/@path/@orderby/@skip/@take"}, $.asUrls); var 
     $win=$(asPageId),
