 $('#i0962b734ef1642179e2d14b313ff8f13').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('Error Log');var asPageEvent = '#i0962b734ef1642179e2d14b313ff8f13'; var asPageId = '.i0962b734ef1642179e2d14b313ff8f13.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({develop_reports_ErrorLog_GetByPagination:"/develop/reports/ErrorLog/GetByPagination/@orderBy/@skip/@take/@typeOrSourceOrMessage/@user/@fromDateTime/@toDateTime",develop_reports_ErrorLog_GetById:"/develop/reports/ErrorLog/GetById/@id",develop_reports_ErrorLog_Delete:"/develop/reports/ErrorLog/delete"}, $.asUrls);     var 
   $btnDell=as("#btnDell"),
                       ...
                       $divMessage.html(error.message);
                        ...
                        $divType.html(error.type);
                         $divWebHostHtmlMessage.html(error.webHostHtmlMessage);
                            $divIsDebugMode.html(exception.IsDebugMode ? "No":"Yes");
                         $divIsMobileMode.html(exception.IsMobileMode ? "No":"Yes");
