...
viewRoleId= 0,
 ...
 $drpLink.asDropdown("init","کشور را انتخاب نمایید",{
    ...
    source: {
        ...
        url: $.asInitService($.asUrls.cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId, [{ name: '@typeId', value: 1024 }])
...
var validateRule = {
       ...
       validate =$frm.asValidate({ rules: validateRule});
        ...
        // }
        //  validate =$frm.asValidate({ rules: rules});
 ...
 var bindEvent =function(){
        ...
        if(this.checked === true)
       {
            if(isLeaf === true)
         {
                 $.asShowMessage({ template: "error", message: "امکان افزودن برگ به برگ دیگر وجود ندارد" })
             $chkNew.prop('checked', false)
         }
            else{
         ...
         $btnDell.click(function () {
            ...
            $.asShowMessage({ template: "error", message: "برای حذف یک لینک را انتخاب نمایید." })
        }
