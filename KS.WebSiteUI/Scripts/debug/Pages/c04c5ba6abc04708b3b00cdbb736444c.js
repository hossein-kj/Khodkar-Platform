 $('#ic04c5ba6abc04708b3b00cdbb736444c').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('مدیریت بارگذاری فایل ها');var asPageEvent = '#ic04c5ba6abc04708b3b00cdbb736444c'; var asPageId = '.ic04c5ba6abc04708b3b00cdbb736444c.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({fms_upload:"/fms/upload"}, $.asUrls); var
     $win=$(asPageId),
