 $('#i633dda51685a4f6bae4794cc31242de3').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('مدیریت خطایابی ها');var asPageEvent = '#i633dda51685a4f6bae4794cc31242de3'; var asPageId = '.i633dda51685a4f6bae4794cc31242de3.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({develop_code_os_dotNet_addOrUpdateDebugInfo:"/develop/code/os/dotnet/addOrUpdateDebugInfo",develop_code_os_dotNet_deleteDebugInfo:"/develop/code/os/dotnet/deleteDebugInfo",develop_code_os_dotNet_GetDebugInfos:"/develop/code/os/dotnet/GetDebugInfos/@orderBy/@skip/@take/@codeId/@data/@integerValue/@decimalValue/@fromDateTime/@toDateTime"}, $.asUrls); var
    $win=$(asPageId),
    $frm = as("#frmDebug"),
