 $('#i3a8ef7fe324e4e90a5f6d66f512a455d').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('تاریخچه رویدادها بر اساس سرویس');var asPageEvent = '#i3a8ef7fe324e4e90a5f6d66f512a455d'; var asPageId = '.i3a8ef7fe324e4e90a5f6d66f512a455d.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId:"/odata/cms/MasterDataKeyValues?$filter=TypeId%20eq%20@typeIdd&$select=Id%2CParentId%2CCode%2CPathOrUrl%2COrder%2CName%2CIsLeaf%2CKey%2CValue",develop_reports_ActionLog_GetById:"/develop/reports/ActionLog/GetById/@id",develop_reports_ActionLog_Delete:"/develop/reports/ActionLog/delete",develop_reports_ActionLog_GetByServiceIdAndPagination:"/develop/reports/ActionLog/GetByServiceIdAndPagination/@orderBy/@skip/@take/@serviceId/@user/@fromDateTime/@toDateTime"}, $.asUrls);     var 
   $btnDell=as("#btnDell"),
