 $('#i0365ec3d059d4405a01aaf2ab4858bf6').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('مدیریت منابع');var asPageEvent = '#i0365ec3d059d4405a01aaf2ab4858bf6'; var asPageId = '.i0365ec3d059d4405a01aaf2ab4858bf6.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({}, $.asUrls); var
    $win=$(asPageId),
        ...
        if(getUrl !== ""){
                ...
                request.url = $.asInitService(getUrl, [
                    ...
                    ,{ name: '@skip', value: skip }
                     ...
                     ,{ name: '@comment', value: $txtComment.val() === "" ? "!": $txtComment.val()}
            ...
            if(selectedChangeSetId !== 0 && asPageParams){
             $(asPageParams.parent).trigger(asPageParams.selectEvent, [selectedChangeSetId]);
              $win.asModal('hide');
                ...
                $.asShowMessage({ template: "error", message:  " تغییری انتخاب نشده است "})
            }
        });
