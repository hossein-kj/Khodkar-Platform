 $('#i85ef1cb9c6074076993e086ac99e2456').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('Debug Management');var asPageEvent = '#i85ef1cb9c6074076993e086ac99e2456'; var asPageId = '.i85ef1cb9c6074076993e086ac99e2456.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({develop_code_os_dotNet_addOrUpdateDebugInfo:"/develop/code/os/dotnet/addOrUpdateDebugInfo",develop_code_os_dotNet_deleteDebugInfo:"/develop/code/os/dotnet/deleteDebugInfo",develop_code_os_dotNet_GetDebugInfos:"/develop/code/os/dotnet/GetDebugInfos/@orderBy/@skip/@take/@codeId/@data/@integerValue/@decimalValue/@fromDateTime/@toDateTime"}, $.asUrls); var
    $win=$(asPageId),
    $frm = as("#frmDebug"),
   ...
   calculateSelectedDebug(e,rows)
    ...
    $btnDell.click(function () {
            ...
            if(selecteds.length === 0){
                $.asShowMessage({template:"error", message: "To remove at least one error must beselect"});
                return;
            }
     ...
     $btnEdit.click(function () {
        ...
        $.each(selectedItems.items,function(i,v){
            ...
            if(selectedCounts !== 1){
                $.asShowMessage({template:"error", message: "To edit at least one error must beselect"});
                return;
            }
