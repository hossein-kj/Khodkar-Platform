 $('#idf042de9f0f940a2b3f56d72ac2ed131').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('WCF Management');var asPageEvent = '#idf042de9f0f940a2b3f56d72ac2ed131'; var asPageId = '.idf042de9f0f940a2b3f56d72ac2ed131.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({develop_code_os_dotNet_getWcfGenreatedCode:"/develop/code/os/dotnet/GetWcfGenreatedCode",cms_masterDataKeyValue_GetByOtherLanguageAndTypeIdAndParentId:"/odata/cms/MasterDataLocalKeyValues?$filter=((MasterDataKeyValue%2FTypeId%20eq%20@typeIdd)%20and%20(MasterDataKeyValue%2FParentId%20eq%20@idd))%20and%20(Language%20eq%20'@lang')&$expand=MasterDataKeyValue&$select=MasterDataKeyValue%2FId%2CMasterDataKeyValue%2FParentId%2CMasterDataKeyValue%2FCode%2CMasterDataKeyValue%2FOrder%2CName"}, $.asUrls); var
     $win=$(asPageId),
     $frm=as("#frmWcf"),
