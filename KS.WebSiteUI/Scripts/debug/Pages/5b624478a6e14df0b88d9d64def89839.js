 $('#i5b624478a6e14df0b88d9d64def89839').on($.asEvent.page.loaded, function (event,requestedUrl,asPageParams) { console.log('ایجاد و ویرایش فایل');var asPageEvent = '#i5b624478a6e14df0b88d9d64def89839'; var asPageId = '.i5b624478a6e14df0b88d9d64def89839.' + $.asPageClass; var as = function(id){var asSelector = new $.as({pageId:asPageId});return asSelector.as(id)};var asOnPageDispose = function(){}; $(asPageEvent).on($.asEvent.page.dispose, function (event) { asOnPageDispose()});  $.asUrls = $.extend({cms_masterDataKeyValue_GetByDefaultsLanguageAndTypeId:"/odata/cms/MasterDataKeyValues?$filter=TypeId%20eq%20@typeIdd&$select=Id%2CParentId%2CCode%2CPathOrUrl%2COrder%2CName%2CIsLeaf%2CKey%2CValue",fms_get:"/fms/Get/@path",fms_save:"/fms/save"}, $.asUrls); var
     $win=$(asPageId),
