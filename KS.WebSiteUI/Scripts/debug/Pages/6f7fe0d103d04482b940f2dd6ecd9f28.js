   ...
   $(".folder-link").click(function(){
    ...
    $btnUploadFromUrl.click(function(){
        if (externalPath !== "") {
            ...
            $.asShowMessage({template:"error", message: "No Base Url Selected"});
          }else 
            $.asShowMessage({template:"error", message: "No Path Selected"});
     });
