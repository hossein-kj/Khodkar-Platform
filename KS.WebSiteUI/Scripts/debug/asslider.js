...
function defineSequence(imagesLoaded, Hammer) {
  ...
  var Sequence = (function (element, options) {
    ...
    self.pagination = {
      ...
      update: function() {
        ...
        if(self.$pagination.elements !== undefined) {
          ...
          // Remove the "active" class from a previous pagination link
          // if there is one
          if (self.$pagination.currentLinks !== undefined) {
            ...
            for (i = 0; i < currentPaginationLinksLength; i++) {
              ...
              removeClass(currentPaginationLink, "active");
            }
          }
          ...
          // add the "active" class to them, then save them for later
          // for when they need to have the "active" class removed
          for (j = 0; j < paginationLength; j++) {
            ...
            addClass(currentPaginationLink, "active");
          }
        }
    ...
    self.destroy = function() {
      ...
      // Remove classes
      removeClass(self.$pagination.currentLinks, "active");
