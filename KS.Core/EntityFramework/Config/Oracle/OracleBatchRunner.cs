...
namespace KS.Core.EntityFramework.Config.Oracle
{
    /// <summary>
    /// A batch execution runner for Oracle Server.
    /// </summary>
    public class OracleBatchRunner : IBatchRunner
    {
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                sqlBuilder.AppendLine(Regex.Split(innerSelect, "WHERE").Last());

                deleteCommand.CommandText = OracleCharSubstitution(sqlBuilder.ToString());
        ...
        public async Task<int> DeleteAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query) where TEntity : class
        {
            DbConnection deleteConnection = null;
            DbTransaction deleteTransaction = null;
            DbCommand deleteCommand = null;
            ...
            where TEntity : class
        {
            ...
            try
            {
                ...
                updateCommand.CommandText = OracleCharSubstitution(sqlBuilder.ToString());
        ...
        public Task<int> UpdateAsync<TEntity>(ObjectContext objectContext, EntityMap entityMap, ObjectQuery<TEntity> query,
        ...
        private string OracleCharSubstitution(string sql)
        {
            return sql
                .Replace('[', '"')
                .Replace(']', '"')
