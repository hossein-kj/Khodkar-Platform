...
namespace KS.Core.FileSystemProvide.Base
{
    ...
    {
        string PhysicalBaseAddress { get; set; }
        void CopyDirectory(string sourceDir, string destinationDir, bool overWrite = true);
        ...
        bool MoveAllFileSByPattern(string sourceDir, string destinationDir, string pattern, bool overWrite);
        ...
        bool DownlodFromUrl(string url, string filePath);
    }
}