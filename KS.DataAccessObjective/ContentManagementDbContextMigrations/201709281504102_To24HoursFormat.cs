namespace KS.DataAccess.ContentManagementDbContextMigrations
{
    ...
    public partial class To24HoursFormat : DbMigration
    {
        ...
        {
            AlterColumn("ContentManagement.Comments", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Comments", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Comments", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Users", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Users", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Users", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.DynamicEntities", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.DynamicEntities", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.DynamicEntities", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataKeyValues", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataKeyValues", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataKeyValues", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataLocalKeyValues", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataLocalKeyValues", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.MasterDataLocalKeyValues", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Links", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Links", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Links", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.FilePaths", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.FilePaths", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.FilePaths", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFilePaths", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFilePaths", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFilePaths", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Files", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Files", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.Files", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFiles", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFiles", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LocalFiles", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.WebPages", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.WebPages", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.WebPages", "AccessLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LanguageAndCultures", "CreateLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LanguageAndCultures", "ModifieLocalDateTime", c => c.String(maxLength: 19));
            AlterColumn("ContentManagement.LanguageAndCultures", "AccessLocalDateTime", c => c.String(maxLength: 19));
        }
